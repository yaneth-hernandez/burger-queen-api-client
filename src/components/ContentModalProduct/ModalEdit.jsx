import { requestEditProducts, requestGetProducts, postImage } from '../../helpers/API_request/productRequest'
 ...
 // if (image[0] !== undefined && image[0] !== null && image[0] !== '') {
  ...
  const handleSubmit = (e) => {
    ...
    requestEditProducts(token, product.id, nameRef.current.value,
                        priceRef.current.value, imgRef.current.src,
    ...
    <section className="containerModal">
      ...
      <form className="formModal" onSubmit={(e) => { handleSubmit(e) }}>
        ...
        <section className="content_imge">
          ...
          <input className="formModal_input" type="file" name="image" onChange={(e) => { handleImage(e) }} required />
          <img ref={imgRef} src={product.image} alt="" className="preview_img" />
        </section>
